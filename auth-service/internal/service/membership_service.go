...
func (s *MembershipService) AddMembership(ctx context.Context, userID, tenantID string) error {
	if err := s.membershipRepository.AddMembership(ctx, userID, tenantID); err != nil {
