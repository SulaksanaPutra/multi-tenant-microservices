...
// Remaining mocks (mockInfrastructureEventPublisher, mockProvisioner, mockMigrator) are
// declared in workspace_initiated_consumer_test.go.
...
var _ InfrastructureEventPublisher = (*mockInfrastructureEventPublisher)(nil)
