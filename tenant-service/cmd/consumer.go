...
func registerConsumers(txManager txcontext.TxManager, rmqClient *rabbitmq.Client, tenantInfrastructureSvc *service.TenantInfrastructureService) (*consumerRunner, error) {
