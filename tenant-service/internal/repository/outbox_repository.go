...
type OutboxRepository interface {
	...
	// CreateOutboxMessageNoTx writes an outbox record outside a transaction.
	// Note: For tenant-service, provisioning now uses transactional DDL wrapping,
	// so this is kept only as a fallback escape hatch.
